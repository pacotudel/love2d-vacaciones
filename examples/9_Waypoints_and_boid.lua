...
function love.load()
	...
	for i = 1,5 do
		...
		pos.x=10 + i*4 + math.random(10, W-10)
		pos.y=10 + i*4 + math.random(10, H-10)
		path:insert(pos)
    end
	path:insert(vector(150,150))
	path:insert(vector(170,150))
	path:insert(vector(180,150))
	path:insert(vector(180,160))
